                ...
                {(isCreating?
                    ...
                    >
                        ...
                        <motion.input
                            ...
                            className='bg-transparent text-base w-full mb-4 border border-white/10 rounded-xl p-3 focus:outline-none placeholder:text-white/20'
                        />
                        ...
                        <motion.textarea
                            ...
                            className='bg-transparent text-base w-full h-32 mb-4 border border-white/10 rounded-xl p-3 focus:outline-none placeholder:text-white/20'
                        />
